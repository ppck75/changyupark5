...
ax.plot(forecast["ds"], forecast["yhat"], label="Predicted", color="red", linestyle="--", linewidth=2)
ax.fill_between(
    forecast["ds"],
    forecast["yhat_lower"],
    forecast["yhat_upper"],
...
ax2.plot(merged["ds"], merged["residual"], label="Residual (Actual - Predicted)", color="purple", linewidth=1.5)
